...
\begin{enumerate}[(a)]
    ...
    \item 
        \begin{description}[labelwidth=1.5cm, leftmargin=!]
            ...
            \item[Opl. :]   Ja, Dabid levert arbeid bij het ronddraaien van de slinger. David voert een kracht uit op de steen waardoor deze rotationeel versneld; hij levert dus arbeid op de steen.
        \end{description}
\end{enumerate}
