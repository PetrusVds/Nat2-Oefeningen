            ...
            \begin{description}[labelwidth=1.5cm, leftmargin=!]
                ...
                \item[] 
                    \vspace{-0.45cm}\begin{minipage}{.6\textwidth}
                        ...
                        De ladingen in de draad zullen een lorentzkracht ondervinden totdat er een evenwicht is, m.a.w. totdat
                        \begin{equation*}
                            \mathcal{E} =  E\ell = vB\ell
                        \end{equation*}
                        het magnetisch veld is een functie van de afstand tot de lange draad
                        \begin{equation*}
