...
\begin{enumerate}[(a)]
    ...
    \item 
        \begin{description}[labelwidth=1.5cm, leftmargin=!]
            \item[Geg. :]   $I$,$s$,$a$
            \item[Gevr. :]  de lorentzkracht $F_L$
            \item[Opl. :]   We berekenen eerst de infinitesimale kracht veroorzaakt door de schuine draden, we weten dat de horizontale componenten elkaar opheffen: 
                            \begin{equation*}
                                dF_{\text{schuin}, y} = \frac{1}{2}\dfrac{\mu_0I^2}{2\pi\sin(60^\circ)}\dfrac{1}{r}dr
                            \end{equation*}
                            Hierover integreren we: 
                            \begin{align*}
                                F_{\text{schuin}, y} &= \frac{1}{2}\int dF_{\text{schuin}, y} \\
                                                  &= \frac{1}{2}\dfrac{\mu_0I^2}{2\pi\sin(60^\circ)} \int_s^{s+a\sin(60^\circ)} \tfrac{1}{r}dr \\
                                                  &= \frac{1}{2}\dfrac{\mu_0I^2}{2\pi\sin(60^\circ)}\left(\ln(\tfrac{s+a\sin(60^\circ)}{s}) \right)
                            \end{align*}
